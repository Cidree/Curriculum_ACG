...
tribble(
    ...
    # UCO ----
    "Forest Engineer - GIS", "University of Córdoba", "September", 2022, "--> Present", NA, "Córdoba - Spain", "PROJECT --- LIFE-FAGESOS",
    
    "Forest Engineer - GIS", "University of Córdoba", "September", 2022, "--> Present", NA, "Córdoba - Spain", "LANGUAGES USED --- R, Markdown, SQL, HTML, CSS",
    
    "Forest Engineer - GIS", "University of Córdoba", "September", 2022, "--> Present", NA, "Córdoba - Spain", "TOOLS USED --- RStudio, Shiny, Quarto, ArcGIS Pro, Google Earth Engine, QGIS, PostgreSQL+PostGIS, VS Code, GitHub",
    
    # Teaching Udemy ----
    "R Teacher", "Udemy", "July", 2023, "--> Present", NA, "Online", "COURSES --- https://www.udemy.com/user/adrian-cidre-gonzalez-2/",
...
tribble(
    ...
    "Toolkit", "RStudio, Shiny Applications, Quarto, ArcGIS Pro, QGIS, PostgreSQL, PostGIS, MongoDB Atlas, Git & GitHub, Learning AWS EC2"
) |> 
  detailed_entries(
    with = area,
    what = skills
...
tribble(
    ...
    "Business Science University", "Shiny Web Applications Part 2 (in progress)",
