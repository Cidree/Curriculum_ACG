...
tribble(
    ...
    "Research Assistant", "University of Córdoba", "September", 2022, "--> Present", NA, "Córdoba - Spain", "LANGUAGES USED --- R, Quarto, SQL, Python, CSS",
    "Research Assistant", "University of Córdoba", "September", 2022, "--> Present", NA, "Córdoba - Spain", "TOOLS USED --- RStudio, ArcGIS Pro, Google Earth Engine, QGIS, PostgreSQL+PostGIS",
...
tribble(
    ~area, ~skills,
    "Programming Languages", "R, SQL, JavaScript for Google Earth Engine, Python",
    "Other Languages", "Markdown, CSS, HTML",
    
    "Specific Software", "RStudio, Quarto, ArcGIS Pro, QGIS, PostgreSQL+PostGIS, Tableau"
) |> 
  detailed_entries(
    with = area,
    what = skills
